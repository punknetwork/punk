    ...
    fn choose_transaction_type(block_number: T::BlockNumber) -> TransactionType {
        ...
        match res {
            ...
            Ok(Ok(block_number)) => {
                ...
                if transaction_type == Zero::zero() { TransactionType::Signed } else if transaction_type == T::BlockNumber::from(1u32) { TransactionType::UnsignedForAny } else if transaction_type == T::BlockNumber::from(2u32) { TransactionType::UnsignedForAll } else { TransactionType::Raw }
            }
